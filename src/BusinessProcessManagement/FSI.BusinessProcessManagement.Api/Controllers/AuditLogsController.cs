...
namespace FSI.BusinessProcessManagement.Api.Controllers
{
    ...
    public class AuditLogsController : ControllerBase
    {
        ...
        public AuditLogsController(IAuditLogAppService service) => _service = service;
        ...
        [HttpPost]
        public async Task<ActionResult<long>> Create([FromBody] AuditLogDto dto)
        {
        ...
        [HttpPut("{id:long}")]
        public async Task<IActionResult> Update(long id, [FromBody] AuditLogDto dto)
        {
            dto.AuditId = id;
